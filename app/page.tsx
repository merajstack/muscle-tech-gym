            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="text-center mb-12">
                <h2
                  ...
                  style={{ fontFamily: "'Bebas Neue', sans-serif", fontWeight: 400 }}
                >
                  OWN A <span className="text-red-600">FRANCHISE</span>
                </h2>
                <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
                  Partner with Muscle Tech and bring the premium fitness experience to your city. Join our growing network of elite gyms across India.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
                ...
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-white">Why Franchise With Us?</h3>
                  <div className="space-y-4">
                    {[
                      { title: "Proven Business Model", desc: "Replicate our successful gym model with full operational support and brand backing." },
                      { title: "Brand Recognition", desc: "Leverage the Muscle Tech brand trusted by thousands of fitness enthusiasts." },
                      { title: "Complete Setup Support", desc: "From site selection to equipment installation, we handle it all for you." },
                      { title: "Training & Certification", desc: "Your staff gets trained by our certified fitness professionals." },
                      { title: "Marketing Support", desc: "National-level campaigns and local marketing strategies to drive footfall." },
                      { title: "Technology Platform", desc: "Access our member management system, billing software, and digital tools." },
                    ].map((item, i) => (
                      <div
                        key={i}
                        className="flex gap-4 p-4 rounded-xl bg-zinc-900/50 border border-zinc-800 hover:border-red-600/30 transition-colors"
                      >
                        <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-red-600/20 flex items-center justify-center text-red-500 font-bold text-sm">
                          {i + 1}
                        </div>
                        <div>
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-red-600/20 via-zinc-900/80 to-zinc-900/80 border border-red-600/30 rounded-2xl p-6 space-y-6">
                    <h3 className="text-xl font-bold text-white">Franchise Investment Details</h3>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                        <span className="text-sm text-zinc-400">Investment Range</span>
                        <span className="text-sm text-white font-semibold">₹25L - ₹50L</span>
                      </div>
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                        <span className="text-sm text-zinc-400">Area Required</span>
                        <span className="text-sm text-white font-semibold">2,000 - 5,000 sq.ft</span>
                      </div>
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                        <span className="text-sm text-zinc-400">Franchise Fee</span>
                        <span className="text-sm text-white font-semibold">₹5L (one-time)</span>
                      </div>
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                        <span className="text-sm text-zinc-400">Royalty</span>
                        <span className="text-sm text-white font-semibold">8% of revenue</span>
                      </div>
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                        <span className="text-sm text-zinc-400">ROI Timeline</span>
                        <span className="text-sm text-white font-semibold">18 - 24 months</span>
                      </div>
                      <div className="flex justify-between items-center py-3">
                        <span className="text-sm text-zinc-400">Agreement Period</span>
                        <span className="text-sm text-white font-semibold">5 years (renewable)</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 text-center space-y-4">
                    <h3 className="text-lg font-bold text-white">Interested in a Franchise?</h3>
                    <p className="text-zinc-400 text-sm">
                      Get in touch with our franchise team to learn more about this opportunity.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3">
                      <a
                        href="https://wa.me/919876543210?text=Hi%2C%20I%20am%20interested%20in%20the%20Muscle%20Tech%20franchise%20opportunity.%20Please%20share%20more%20details."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-colors text-sm text-center"
                      >
                        WhatsApp Us
                      </a>
                      <a
                        href="mailto:franchise@muscletechgym.com?subject=Franchise%20Inquiry"
                        className="flex-1 px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors text-sm text-center"
                      >
                        Email Us
                      </a>
                    </div>
